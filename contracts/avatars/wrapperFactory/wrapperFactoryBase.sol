...
import "../../proxyContracts/factory/springFactory.sol";
import "../../proxyContracts/proxy/springProxy.sol";
import "../../modifiers/budgetModifier.sol";
import "../../proxyContracts/factory/IGnosisSafeProxy.sol";
import "../../modules/safeWrapper/safeWrapperLogic.sol";
...
contract wrapperFactoryBase is springFactory, springAvatar {
    ...
    // function enableModule(address module) override public{
    //     require(module == address(0), "not callable");
    // }
